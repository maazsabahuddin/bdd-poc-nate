...
class Pattern:
    ...
    ADD_TO_PATTERN = "//*[contains(text(), 'ADD TO BAG') or contains(text(), 'Add to BAG') or contains(text(), 'Add To BAG') or contains(text(), 'Add to Cart') or contains(text(), 'ADD TO CART') or contains(text(), 'Add to cart')]"
