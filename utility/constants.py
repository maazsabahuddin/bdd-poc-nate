...
class Pattern:
    ...
    ADD_TO_PATTERN = "//*[contains(translate(text(), 'ABDGOT', 'abdgot'), 'add to bag') or contains(translate(text(), 'ACDORT', 'acdort'), 'add to cart') or contains(translate(@value, 'ACDORT', 'acdort'), 'add to cart') or contains(translate(@aria-label, 'ABDGOT', 'abdgot'), 'add to bag') or contains(text(), 'ADD') or contains(normalize-space(translate(@name, 'ABDGOT', 'abdgot')), 'addtobag')]"
    ...
    EMAIL = "//*[contains(translate(@name, 'EMAIL', 'email'), 'email') or contains(translate(@type, 'EMAIL', 'email'), 'email')]"
