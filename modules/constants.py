...
class Pattern:
    ...
    VIEW_CART = "//*[contains(translate(text(), 'VIEWBAG', 'viewbag'), 'view bag') or contains(translate(text(), 'CHEKOUT', 'chekout'), 'checkout') or contains(translate(text(), 'CHEKOUT', 'chekout'), 'check out')]"
